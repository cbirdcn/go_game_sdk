...
func (x *CheckEnterRequest) Reset() {
	*x = CheckEnterRequest{}
...
func (x *CheckEnterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckEnterRequest) ProtoMessage() {}

func (x *CheckEnterRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_sdk_v1_sdk_proto_msgTypes[0]
...
// Deprecated: Use CheckEnterRequest.ProtoReflect.Descriptor instead.
func (*CheckEnterRequest) Descriptor() ([]byte, []int) {
	return file_api_sdk_v1_sdk_proto_rawDescGZIP(), []int{0}
}

func (x *CheckEnterRequest) GetAppId() uint32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *CheckEnterRequest) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *CheckEnterRequest) GetSign() string {
	if x != nil {
		return x.Sign
	}
	return ""
...
func (x *CheckEnterReply) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *CheckEnterReply) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
var file_api_sdk_v1_sdk_proto_rawDesc = []byte{
	...
	,
...
var file_api_sdk_v1_sdk_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_sdk_v1_sdk_proto_goTypes = []interface{}{
	(*CheckEnterRequest)(nil), // 0: sdk.v1.CheckEnterRequest
	(*CheckEnterReply)(nil),   // 1: sdk.v1.CheckEnterReply
}
var file_api_sdk_v1_sdk_proto_depIdxs = []int32{
	0, // 0: sdk.v1.Sdk.CheckEnter:input_type -> sdk.v1.CheckEnterRequest
	1, // 1: sdk.v1.Sdk.CheckEnter:output_type -> sdk.v1.CheckEnterReply
...
func file_api_sdk_v1_sdk_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_sdk_v1_sdk_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckEnterRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
